...
AS (SELECT DISTINCT host_id as id, host_url as url, host_name as name, host_since as since,
	host_location as location, host_about as about,
	host_response_time as response_time, host_response_rate as response_date,
	host_acceptance_rate as acceptrance_rate,
	host_is_superhost as is_superhost,host_thumbnail_url as thumbnail_url,
	...
	host_verifications as verifications, host_has_profile_pic as has_profile_pic,
